    ...
    <div  className='relative col-span-2 z-10 md:text-center lg:text-left !mt-[-20px] ' >
        ...
        <div className='relative' >
            ...
            <div className='my-5 md:my-8 leading-7 text-slate-400 md:text-lg max-w-3xl' >
               <AnimatedTextWord 
                  text="Highly motivated and very passionate Full Stack Developer with 7 years of experience in Typescript, React, Sveltekit, Next js, Firebase, Supabase, Tailwind CSS, Node, Express.js, MySQL, MongoDB, GraphQL"
